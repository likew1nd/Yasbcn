...
class AlertDialog(QMessageBox):
    def __init__(
        ...
        self.ok_button = self.addButton("确定", QMessageBox.ButtonRole.AcceptRole) if show_ok else None
        self.quit_button = self.addButton("退出", QMessageBox.ButtonRole.DestructiveRole) if show_quit else None
