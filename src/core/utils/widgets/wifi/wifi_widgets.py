...
class WifiItem(QFrame):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        self.ssid_field.setPlaceholderText("网络名称")
    ...
    def data(self, data: NetworkInfo):
        ...
        display_name = "隐藏网络" if data.ssid == "<Hidden Network>" else data.ssid
        self.wifi_name.setText(display_name)
    ...
    def update_state(self, set_active: bool | None = None):
        ...
        if self._active:
            ...
            self.connect_button.setText("断开" if self.state & WifiState.CONNECTED else "连接")
